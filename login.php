...
<body class="align" id="bg" background="your%20name.png" style="background-size: cover">

<div class="grid">
    <form method="POST" class="form login" action="connect.php">
        ...
        <div class="form__field">
            ...
            <input id="login__username" name="id" type="text" class="form__input" placeholder="Username" required >
        </div>
    ...
    <p class="text--center" style="font-weight: bold;font-family: 華康娃娃體W7;font-size: 20px">
...
<svg xmlns="http://www.w3.org/2000/svg" class="icons"><symbol id="arrow-right" viewBox="0 0 1792 1792">
    ...
    </symbol><symbol id="lock" viewBox="0 0 1792 1792">
        <path d="M640 768h512V576q0-106-75-181t-181-75-181 75-75 181v192zm832 96v576q0 40-28 68t-68 28H416q-40 0-68-28t-28-68V864q0-40 28-68t68-28h32V576q0-184 132-316t316-132 316 132 132 316v192h32q40 0 68 28t28 68z"/>
    </symbol><symbol id="user" viewBox="0 0 1792 1792">
